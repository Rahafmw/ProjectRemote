...
//When the form button ( fav) is submitted
  ...
  function fav1() 
{
 ...
 $sql = "INSERT INTO fav_place (place_name) VALUES ('UNESCO Heritage Site: At-Turaif')";
 ...
 function fav1_2() 
{
 ...
 // Performing insert query execution
 // here our table name is review_card2
 $sql = "INSERT INTO fav_place (place_name) VALUES ('Al Masmak Fortr')";
 ...
 function fav2_1() 
{
 ...
 // Performing insert query execution
 // here our table name is review_card2
 $sql = "INSERT INTO fav_place (place_name) VALUES ('Al Nakheel Mall')";
 ...
 function fav2_2() 
{
 ...
 // Performing insert query execution
 // here our table name is review_card2
 $sql = "INSERT INTO fav_place (place_name) VALUES ('Riyadh shopping mall')";
 ...
 function fav3_1() 
{
 ...
 // Performing insert query execution
 // here our table name is review_card2
 $sql = "INSERT INTO fav_place (place_name) VALUES ('On safari in Nofa Wild life park')";
 ...
 function fav3_2() 
{
 ...
 // Performing insert query execution
 // here our table name is review_card2
 $sql = "INSERT INTO fav_place (place_name) VALUES ('BLVD Skate Park')";
...
<!-- (Art & Culture) -->
<div class="w3-content w3-padding-large w3-margin-top w3-border w3-panel " id="Art & Culture"> 
  <br> 
  <div class="w3-center "> 
  ...
  <div class="w3-row w3-padding-64">
    ...
    <a href="recommendations.html" class="w3-opacity linkPlace"> See more related places</a>
</div> 
</div> 

<!-- (Shooping) -->
<div class="w3-content w3-padding-large w3-margin-top w3-border w3-panel " id="Shooping"> 
  <br> 
  <div class="w3-center "> 
...
<!-- (Adventures & Sports) -->
<div class="w3-content w3-padding-large w3-margin-top w3-border w3-panel " id="Adventures & Sports"> 
  <br> 
  <div class="w3-center "> 
